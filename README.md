...
This project allows you to record audio and transcribe it using `ffmpeg` and `whisper` on an Ubuntu distrobution. It captures any audio played through your soundcard and converts it to text.
